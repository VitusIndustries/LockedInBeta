...
class HabitWidget : GlanceAppWidget() {
    ...
    // Enable responsive sizing to prevent lag when resizing
        ...
        if (habits.isEmpty()) {
            ...
            androidx.glance.appwidget.lazy.LazyColumn {
                items(habits.size) { index ->
                    ...
                    HabitRow(habit = habit, doneToday = habit.lastCompletedDate == today)
                }
            }
        }
    }
...
@Composable
private fun HabitRow(habit: Habit, doneToday: Boolean) {
